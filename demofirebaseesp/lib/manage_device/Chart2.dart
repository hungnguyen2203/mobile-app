...
class Chart2 extends StatefulWidget {
  ...
  @override
  State<Chart2> createState() => _ChartScreenState1();
}

class _ChartScreenState1 extends State<Chart2> {
  ...
  void getPostsData() {
    List<dynamic> responseList = FOOD_DATA2;
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          backgroundColor: Color.fromARGB(255, 232, 179, 19),
          // leading: Icon(
          //   Icons.menu,
          //   color: Colors.black,
          // ),
