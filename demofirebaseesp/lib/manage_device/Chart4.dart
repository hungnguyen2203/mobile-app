...
class Chart4 extends StatefulWidget {
  ...
  const Chart4({Key? key}) : super(key: key);
  @override
  State<Chart4> createState() => _ChartScreenState1();
}

class _ChartScreenState1 extends State<Chart4> {
  ...
  void getPostsData() {
    List<dynamic> responseList = FOOD_DATA4;
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          backgroundColor: Color.fromARGB(255, 6, 178, 60),
          // leading: Icon(
          //   Icons.menu,
          //   color: Colors.black,
          // ),
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                       Image.asset('assets/images/4GREAL.png'),
                        SizedBox(
                        height: 10,
                      ),
                      Center(
                ...
                child: Container(
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Image.asset('assets/images/4G.jpg'),
                         SizedBox(
                          height: 10,
                        ),
                        Center(
