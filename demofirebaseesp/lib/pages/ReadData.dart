          ...
          itemBuilder:  (context, snapshot, animation, index) {
            ...
            return Card(
              shape: RoundedRectangleBorder(
                side: BorderSide(
                  color: Color.fromARGB(230, 16, 47, 92), // Màu sắc viền
              ...
              child: ListTile(
                ...
                title: Text('Device:${snapshot.child('gateway1').child('device').value.toString()}  Time:${snapshot.child('gateway1').child('time').value.toString()}',
                    style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 18,
                  ),),
                ...
                children: [
                Text('Temperature: ${snapshot.child('gateway1').child('data1').value.toString()} *C',
                    style: TextStyle(
                    fontWeight: FontWeight.bold,
                    color: Color.fromARGB(255, 231, 132, 67),
                    fontSize: 18,
                  ), ),
                Text('Humidity: ${snapshot.child('gateway1').child('data2').value.toString()} %',
                    style: TextStyle(
                    fontWeight: FontWeight.bold,
